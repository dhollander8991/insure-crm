...
vi.mock('../components/forms/new-policy-dialog', () => ({
...
const mockPolicies = [
  { id: 1, policyNumber: 'P-001', customerId: 1, customerName: 'John Doe', type: 'CAR' as const, status: 'ACTIVE' as const, startDate: '2024-01-01', endDate: '2026-01-01', premium: 200, agentEmail: 'agent@test.com' },
  { id: 2, policyNumber: 'P-002', customerId: 2, customerName: 'Jane Smith', type: 'LIFE' as const, status: 'PENDING' as const, startDate: '2024-06-01', endDate: '2026-06-01', premium: 500, agentEmail: 'agent@test.com' },
];
...
describe('PoliciesPage', () => {
  ...
  it('shows error state when API fails', async () => {
    vi.mocked(policyApi.getAll).mockRejectedValue(new Error('Service unavailable'));
    renderWithProviders(<PoliciesPage />);
