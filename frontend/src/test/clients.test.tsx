...
vi.mock('../components/forms/new-client-dialog', () => ({
...
const mockCustomers = [
  { id: 1, firstName: 'Alice', lastName: 'Anderson', email: 'alice@test.com', phone: '050-1111111', israeliId: '111111111', dateOfBirth: '1990-01-01', agentEmail: 'agent@test.com', status: 'ACTIVE' as const },
  { id: 2, firstName: 'Bob', lastName: 'Brown', email: 'bob@test.com', phone: '050-2222222', israeliId: '222222222', dateOfBirth: '1985-05-05', agentEmail: 'agent@test.com', status: 'PROSPECT' as const },
  { id: 3, firstName: 'Carol', lastName: 'Clark', email: 'carol@test.com', phone: '050-3333333', israeliId: '333333333', dateOfBirth: '1992-03-15', agentEmail: 'agent@test.com', status: 'INACTIVE' as const },
];
