...
describe("NewClientDialog", () => {
  ...
  it("renders form fields when open", () => {
    renderWithProviders(
      <NewClientDialog open={true} onOpenChange={() => {}} />,
    );
  ...
  it("does not render fields when closed", () => {
    renderWithProviders(
      <NewClientDialog open={false} onOpenChange={() => {}} />,
    );
  ...
  it("calls onOpenChange(false) when Cancel is clicked", async () => {
    ...
    renderWithProviders(
      <NewClientDialog open={true} onOpenChange={onOpenChange} />,
    );
...
describe("NewPolicyDialog", () => {
  ...
  it("renders form fields when open", () => {
    renderWithProviders(
      <NewPolicyDialog open={true} onOpenChange={() => {}} />,
    );
  ...
  it("does not render fields when closed", () => {
    renderWithProviders(
      <NewPolicyDialog open={false} onOpenChange={() => {}} />,
    );
  ...
  it("shows error when customerId is not positive", async () => {
    ...
    await waitFor(() => {
      expect(
        screen.getByText("Customer ID must be positive"),
      ).toBeInTheDocument();
    });
  });
  ...
  it("calls onOpenChange(false) when Cancel is clicked", async () => {
    ...
    const onOpenChange = vi.fn();
    renderWithProviders(
      <NewPolicyDialog open={true} onOpenChange={onOpenChange} />,
    );
