...
export function KpiCard({ label, value, prefix, suffix, delta, icon: Icon, index = 0 }: KpiCardProps) {
  const up = delta >= 0;
        ...
        <Card className="relative overflow-hidden p-5 transition-shadow duration-300 hover:shadow-[var(--shadow-lifted)]">
          ...
          <div className="relative flex items-start justify-between gap-3" style={{ transform: "translateZ(30px)" }}>
            <div className="min-w-0 flex-1 space-y-1.5">
              ...
              <p className={cn("font-semibold tracking-tight tabular-nums leading-none", isLargeValue ? "text-3xl" : "text-4xl")}>
                <CountUp to={value} prefix={prefix} suffix={suffix} />
              </p>
              <div className={cn("inline-flex flex-wrap items-center gap-1 text-xs font-medium", up ? "text-success" : "text-destructive")}>
            ...
            <div
              ...
              style={{ background: "var(--gradient-primary)", transform: "translateZ(50px)" }}
            >
